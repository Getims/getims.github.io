...
namespace Project.Scripts.Runtime.Scenes.Game
{
    public class GameSceneInstaller : MonoInstaller
    {
        ...
        public override void Start()
        {
            ...
            Container.Resolve<IPlatformsInfoService>().Initialize();
        }
        ...
        private void BindSceneObjects()
        {
            ...
            Container.BindInterfacesTo<PlatformsInfoService>().AsSingle().NonLazy();
            Container.BindInterfacesTo<InputService>().AsSingle().NonLazy();

            Container.Bind<GameEventsProvider>().AsSingle().NonLazy();
        }
